...
const { random } = Math
const declineBooking = require('./decline-booking')
    ...
    describe('when user already exists', () => {
        ...
        describe('unhappy paths', () => {
            it('should fail on a non-string user publisherId', () => {
                ...
                _id2 = '23234sfasf'
                _spotId = '32j43b34kb'
                expect(() => declineBooking(_id, _id2, _spotId)).to.throw(TypeError, `publisherId ${_id} is not a string`)
            ...
            it('should fail on a non-string candidateId', () => {
                ...
                _id2 = 9328743289
                _spotId = '32j43b34kb'
                expect(() => declineBooking(_id, _id2, _spotId)).to.throw(TypeError, `candidateId ${_id2} is not a string`)
            ...
            it('should fail on a non-string spotId', () => {
                ...
                _id2 = '32j43b34kb'
                _spotId = 9328743289
                expect(() => declineBooking(_id, _id2, _spotId)).to.throw(TypeError, `spotId ${_spotId} is not a string`)
