    ...
    describe('when user already exists', () => {
        ...
        it('should succeed on correct and valid and right data', () => {
            ...
            User.findById(id)
                ...
                .then(() => spotUpdate({id, title, addressLocation, addressStNumber, addressOther, length, width, height, area, description, price, acceptsBarker, surveillance, isCovered, hourStarts, hourEnds, mon, tue, wed, thu, fri, sat, sun}, _spotId)
        ...
        it('should fail if the Spot does not exist', () => {
            ...
            body = {id, title, addressLocation, addressStNumber, addressOther, length, width, height, area, description, price, acceptsBarker, surveillance, isCovered, hourStarts, hourEnds, mon, tue, wed, thu, fri, sat, sun}
            _spotId = `${_spotId}-wrong`
            spotUpdate(body, _spotId)
